        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Manage Notifications</h3> </div>
                  ...
                  <div class="col-md-12">
                    <div class="card">
                      ...
                      <form action="" class="form-horizontal input-field">
                        <h6>Send Notifications To:</h6>
                          <label class="radio" onclick="allSelect();"><input class="radion-set" type="radio" name="optradio" checked>All</label>
                          <label class="radio" onclick="allEmployer();"><input class="radion-set" type="radio" name="optradio">All Employer</label>
                                ...
                                <div class="view-details">
                                  ...
                                  <div class="button-group">
                                    <div class="">
                                      ...
                                      <button data-toggle="modal" data-target="#notification1" class="btn btn-black">Send Notification
                                      </button>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div class="view-details">
                                  ...
                                  <div class="button-group">
                                    <div class="">
                                      ...
                                      <button data-toggle="modal" data-target="#notification3" class="btn btn-black">Send Notification</button>
                                    </div>
                                  </div>
                                </div>
                              </div>
                          ...
                          <div class="form-group notification_allemployer" style="display: none;">
                            <label for="">Title</label>
                            <div class="col-md-6" style="padding: 0;">
                              <input class="form-control" type="text" name="name" maxlength="20" id="title" required>
                            </div>
                        ...
                        <div class="form-group button-group ">
                          <div class="text-text">
                            <button class="btn btn-primary btn-black btn-send-not" style="margin-right: 0;">Send Notification</button>
                          </div>
                        </div>
                        </div>
                      </form>
                            ...
                            <form class="" action="index.html" method="post">
                              ...
                              <div class="col-md-12" style="padding: 0;">
                                ...
                                <div class="form-group button-group " style="margin-top: 1rem;">
                                  <div class="text-text">
                                    <button class="btn btn-primary btn-black" style="margin-right: 0;" type="submit">Send Notification</button>
                                  </div>
                                </div>
                            </form>
                          </div>
