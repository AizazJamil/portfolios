    ...
    <div class="page-wrapper">
      ...
      <div class="row page-titles">
        <div class="col-md-5 align-self-center">
          <h3 class="text-primary">View Employer</h3> </div>
                  ...
                  <div class="overview col-md-7">
                    <div class="col-md-12 right-modal">
                      <div class="details-manage">
                        <h4>Website</h4>
                        <p class="para-item">info.com</p>
                      </div>
                      <div class="details-manage">
                        <h4>Company Description</h4>
                        <p class="para-item">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
                      </div>
                      <div class="details-manage">
                        <h4>Contact Person</h4>
                        <p class="para-item">Contact Value</p>
                      </div>
                      <div class="details-manage">
                        <h4>Contact No</h4>
                        <p class="para-item">Number Value</p>
                      </div>
                      <div class="details-manage">
                        <h4>Email</h4>
                        <p class="para-item">info@gmail.com</p>
                      </div>
                      <div class="details-manage">
                        <h4>Address</h4>
                        <p class="para-item">Address Value</p>
                      </div>
                      <div class="details-manage">
                        <h4>Country</h4>
                        <p class="para-item">Country Value</p>
                      </div>
                      <div class="details-manage">
                        <h4>State</h4>
                        <p class="para-item">State Value</p>
                      </div>
